...
class MyCNN(nn.Module):
    def __init__(self):
        ...
        self.cnn2 = nn.Conv2d(in_channels=64, out_channels=128, kernel_size=3, stride=1, padding=1)   # ((224+2*1-3)/1)+1=224  # output_shape=(64,224,224)
        self.relu2 = nn.ReLU()
        self.maxpool2 = nn.MaxPool2d(kernel_size=2)    # output_shape=(64,56,56)

        self.cnn3 = nn.Conv2d(in_channels=128, out_channels=256, kernel_size=3, stride=1, padding=1)   # output_shape=(64,112,112)
        self.relu3 = nn.ReLU()
        self.maxpool3 = nn.MaxPool2d(kernel_size=2)  # output_shape=(64,28,28)

        self.cnn4 = nn.Conv2d(in_channels=256, out_channels=512, kernel_size=3, stride=1, padding=1)   # output_shape=(64,56,56)
        self.relu4 = nn.ReLU()
        self.cnn5 = nn.Conv2d(in_channels=512, out_channels=512, kernel_size=3, stride=1, padding=1)   # output_shape=(64,56,56)
        self.relu5 = nn.ReLU()
